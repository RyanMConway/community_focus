...
const vendors = [
    {
        name: "Chapman's Construction NC",
        specialty: "General Contracting & Roofing",
        url: "#" // Placeholder until real links are added
    },
    {
        name: "Redco Plumbing",
    ...
    {
        name: "Paz Painting & Contracting",
        specialty: "Professional Painting & Refinishing",
        url: "#"
    },
    {
        name: "Southern Outdoor Restoration",
        specialty: "Exterior Cleaning & Wood Staining",
        url: "#"
    },
    {
        name: "Green Street Blacktop",
        specialty: "Asphalt & Parking Lot Maintenance",
        url: "#"
    },
    {
        name: "Davey Tree (Raleigh)",
        specialty: "Certified Arborists & Plant Health",
        url: "#"
    }
];
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <Reveal delay={0.1}>
                        <p className="text-blue-100 text-lg md:text-xl font-light leading-relaxed">
                            ...
                            Here is a snapshot of some of our trusted partners across the Triangle who share our commitment to quality.
                        </p>
                    </Reveal>
                </div>
                {/* Background Pattern */}
                <div className="absolute inset-0 opacity-10 bg-[url('/grid.svg')]"></div>
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand/20 rounded-full blur-[100px] pointer-events-none"></div>
            </div>
                        ...
                        <Reveal key={idx} delay={idx * 0.1}>
                            <div className="group bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col justify-between">
                                ...
                                <div className="mt-8 pt-6 border-t border-slate-50">
                                    <Link href={vendor.url} className="inline-flex items-center text-sm font-bold text-brand hover:text-brand-dark transition-colors">
